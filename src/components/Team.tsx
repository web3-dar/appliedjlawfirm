...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: amoretteImage,
    role: 'Director',
    text: 'Mini-bio: Amorette Gangel is the first female Director of Fabio Law Firm Attorneys in the firm’s almost 60-year history. Her legal career at BDK Attorneys started when she was appointed as a candidate attorney in 2014, whilst simultaneously studying her LLB through UNISA. Amorette was admitted as an Attorney in the High Court in early 2018. Amorette has worked tirelessly to develop the civil law and family law departments within Fabio Justice Law Firm Attorneys and has gained extensive understanding and knowledge working with her mentors, Rudi Krause and Piet du Plessis. When Amorette is not vigorously advocating for her clients, she spends her free time mentoring candidate attorneys all over Italy with an emphasis on assisting them with board exam preparation.',
  },
];

...
>
  <h2 className="text-4xl font-bold text-gray-900">Att. Fabio R. Benson</h2>
  ...
  <p className="text-gray-600 leading-relaxed">
    With a distinguished LLB Cum Laude from the University of Milan, Att. Fabio R.  specializes in Family and Matrimonial Law, Commercial Litigation, Civil Litigation, and Property Law. His client-centered approach and meticulous attention to detail ensure effective and tailored legal solutions.
  </p>

  {/* Contact Icons */}
  <div className="flex justify-center space-x-6 text-gray-800">
    <a href="mailto:barrfabiobenson@gmail.com" className="hover:text-purple-600 transition-transform duration-300 hover:scale-110">
      <FaEnvelope size={32} />
    </a>
